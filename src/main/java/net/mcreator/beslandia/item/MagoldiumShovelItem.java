...
public class MagoldiumShovelItem extends ShovelItem {
	public MagoldiumShovelItem() {
		super(new Tier() {
			public int getUses() {
				return 8192;
			}
		...
		}, 1, -2.8f, new Item.Properties().tab(BeslandiaModTabs.TAB_BESLANDIA_CREATIVE_TAB).fireResistant());
	}
}
